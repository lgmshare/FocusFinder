...
import com.aomiga.focus.custom.BrushView;
import com.aomiga.focus.custom.TouchImageView;

public class MagnifierTxActivity extends AppCompatActivity {
...
//        this.originalBitmap = ImageUtils.getBitmap(path);
        this.originalBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.permissioned_cover);
